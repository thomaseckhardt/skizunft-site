          ...
          <div className="mt-4">
                ...
                <li className="py-6">
                  <div className="min-w-0 flex-1">
                    <h4 className="flex gap-x-1 text-sm">
                      ...
                      <span className="flex-none" x-text="'('+kid.age+' Jahre)'"
                      ></span>
                    </h4>
                    <div className="mt-1">
                      <template x-for="date in kid.dates" :key="date">
                        <p className="text-sm text-gray-500" x-text="date"></p>
                      </template>
                    </div>
                  </div>
                  <div className="mt-1 flex justify-end gap-x-2 text-right text-sm">
                    <p v-show="kid.isMember" className="text-gray-500">
                      Vereinsmitglied
                    </p>
                    <p
            ...
            <dl className="space-y-6 border-t border-gray-200 py-6">
              <div className="flex items-center justify-between">
                <dt className="text-sm">Zwischensumme</dt>
                <dd
              ...
              <div className="flex items-center justify-between border-t border-gray-200 pt-6 text-sky-600">
                <dt className="text-base font-semibold md:text-lg">
                  Fälliger Betrag
                </dt>
                <dd
              ...
              <div className="mt-6 rounded border border-sky-600 bg-sky-50 p-4 text-sm text-sky-700">
                ...
                <strong className="whitespace-nowrap">5 Tage</strong> vor
                Kursbeginn auf unser Bankkonto. Alle Infor­mationen bekommst du
                in der Buchungs­bestätigung per Mail.
              </div>
            </dl>
          </div>
        </div>
